...
<script type="text/javascript">
    ...
    var exportAccountReimburse = function () {
        jsPostForm('../service/ReimburseOutlay.ashx/ExportUserPublicAccountReimburse?type=1', $.serializeObject($('#pasearchForm')));
    };
    //转账支出表
    var accountGrid;
    $(function () {
        ...
        accountGrid = $('#accountGrid').datagrid({
            title: '转账支出明细',
            url: '../service/ReimburseOutlay.ashx/GetAccountPay?type=1',
            striped: true,
            rownumbers: true,
            pagination: true,
            noheader: true,
            ...
            onLoadSuccess: function (data) {
                ...
                //提示框
                $(this).datagrid('tooltip', ['memo', 'payeename', 'accountnumber', 'bankname', 'auditorcomment']);
            }
        });
        //设置分页属性
...
<div id="agTip">
    ...
    <table>
        <tr>
            ...
            <td>
                <input style="width:60px" name="finishstatus" id="finishstatus" class="easyui-combobox" data-options="panelHeight:'auto',editable:false,valueField:'value',textField:'text',data:[{'value':'0','text':'待受理'},{'value':'2','text':'已办结'}],onSelect:function(rec){(rec.value>0)&&$('#pasearchForm').find('#status').combobox('setValue','3');}" />
            </td>
            <td>
